...
#include"../../CODICE_GPU_STORICO/rhmc_20_07_11_topo+B/Include/global_macro.cc"
#include"../../CODICE_GPU_STORICO/rhmc_20_07_11_topo+B/Include/parameters.cc"
#include"../../CODICE_GPU_STORICO/rhmc_20_07_11_topo+B/Include/global_const.cc"

#include"../RationalApprox/rationalapprox.cc"
...
//  FILE *output = fopen("REMEZ_approx.dat", "a");
  ...
  FILE *input = fopen("./RationalApprox/SAVED_APPROX/order18_power_plus_2_over_16.approx", "rt");
  fscanf(input, "%lf\n", &norm);
  for(int i = 0; i < n; i++){
    fscanf(input, "%lf  %lf\n", &res1[i],&pole1[i]);
  }
