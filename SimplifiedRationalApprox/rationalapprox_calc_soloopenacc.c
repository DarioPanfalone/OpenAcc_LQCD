...
void rationalapprox_read_soloopenacc(COM_RationalApprox *first_inv_approx_norm_coeff,COM_RationalApprox *md_inv_approx_norm_coeff,COM_RationalApprox *last_inv_approx_norm_coeff)
  ...
  double *res1;
  double *pole1;
  posix_memalign((void **)&res1, ALIGN, n*sizeof(double));
  posix_memalign((void **)&pole1, ALIGN, d*sizeof(double));
  ...
  first_inv_approx_norm_coeff->COM_min_epsilon=lambda_low;
  first_inv_approx_norm_coeff->COM_approx_order=n;
  first_inv_approx_norm_coeff->COM_RA_a0=norm;
  for(int i=0;i<max_approx_order;i++){
    first_inv_approx_norm_coeff->COM_RA_a[i]=res1[i];
    first_inv_approx_norm_coeff->COM_RA_b[i]=pole1[i];
  }
  ...
  double *res2;
  double *pole2;
  posix_memalign((void **)&res2, ALIGN, n*sizeof(double));
  posix_memalign((void **)&pole2, ALIGN, d*sizeof(double));
  ...
  md_inv_approx_norm_coeff->COM_min_epsilon=lambda_low;
  md_inv_approx_norm_coeff->COM_approx_order=n;
  md_inv_approx_norm_coeff->COM_RA_a0=norm;
  for(int i=0;i<max_approx_order;i++){
    md_inv_approx_norm_coeff->COM_RA_a[i]=res2[i];
    md_inv_approx_norm_coeff->COM_RA_b[i]=pole2[i];
  }
  ...
  double *res3;
  double *pole3;
  posix_memalign((void **)&res3, ALIGN, n*sizeof(double));
  posix_memalign((void **)&pole3, ALIGN, d*sizeof(double));
  ...
  last_inv_approx_norm_coeff->COM_min_epsilon=lambda_low;
  last_inv_approx_norm_coeff->COM_approx_order=n;
  last_inv_approx_norm_coeff->COM_RA_a0=norm;
  for(int i=0;i<max_approx_order;i++){
    last_inv_approx_norm_coeff->COM_RA_a[i]=res3[i];
    last_inv_approx_norm_coeff->COM_RA_b[i]=pole3[i];
  }
