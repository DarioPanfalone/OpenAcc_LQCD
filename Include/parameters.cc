...
const REAL mass=0.0125;//0.01335; //0.04303;
...
// RHMC parameters
const int max_cg=10000;             // maximum number of iteration in CG inverter

 const REAL inv_single_double_prec=1.0e-4;  // if stopping residue <inv_single_double_prec inverter use double prec, else single
