...
pgcc  -acc  -Minfo=accel -O3  -v -ta=tesla:cc35,cuda7.0,time,keep,ptxinfo -c  Rand/random.c                   2> msg_err_0 #-Mcuda=maxregcount:128 
pgcc  -acc  -Minfo=accel -O3  -v -ta=tesla:cc35,cuda7.0,time,keep,ptxinfo -c  OpenAcc/include_all_main.c      2> msg_err_1 #-Mcuda=maxregcount:128 
pgcc  *.o -o prog_solo -acc  -Minfo=accel -O3 -v -ta=tesla:nollvm,cuda7.0,time,keep,ptxinfo                     2> msg_err_3 #-Mcuda=maxregcount:128  
