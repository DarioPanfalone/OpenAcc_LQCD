...
static inline void cabibbo_marinari_cooling(__restrict su3_soa   * const U, // configurazione "calda" in entrata
  ...
  */
  ...
  A = A * norm;
  B = B * norm;
  // la matrice T e' il link U raffreddatto lungo il primo sottogruppo
  ...
  A = A * norm;
  B = B * norm;
  // la matrice U e' il link (che adesso si chiamava T) raffreddatto lungo il secondo sottogruppo
  U00 = A * T00 + B * T20;
  U01 = A * T01 + B * T21;
  U02 = A * T02 + B * T22;
  U10 = T10;
