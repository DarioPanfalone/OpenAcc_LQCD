...
static inline void loc_unitarize_conf(
...
// mat1 = mat1 * mat2 
#pragma acc routine seq
static inline void    mat1_times_mat2_into_mat1_absent_stag_phases( 
...
#pragma acc routine seq
static inline void    mat1_times_conj_mat2_into_mat1_absent_stag_phases(
        __restrict su3_soa * const mat1,
        const int idx_mat1,
        __restrict const su3_soa * const mat2,
        const int idx_mat2)
...
#pragma acc routine seq
static inline void mat1_times_conj_mat2_times_fact_addto_mat3_absent_stag_phases(
										 __restrict const su3_soa * const mat1, const int idx_mat1,
										 __restrict const su3_soa * const mat2, const int idx_mat2,
										 double fact,
										 __restrict su3_soa * const mat3,   const int idx_mat3)
...
#pragma acc routine seq
static inline double half_tr_thmat_squared( 
...
#pragma acc routine seq
static inline double half_tr_tamat_squared( 
        const __restrict tamat_soa * const mom,
        int idx_mom)
{
  d_complex  C = mom->c01[idx_mom];
  d_complex  D = mom->c02[idx_mom];
...
#pragma acc routine seq
static inline void assign_zero_to_su3_soa_component(
        __restrict su3_soa * const matrix_comp,
        int idx)
{
                                                       ...
                                                       int idx,int idx1)
{
    ...
    matrix_comp_out->r0.c0[idx] =  matrix_comp_in->r0.c0[idx1];
    matrix_comp_out->r0.c1[idx] =  matrix_comp_in->r0.c1[idx1];
    matrix_comp_out->r0.c2[idx] =  matrix_comp_in->r0.c2[idx1];
    
    matrix_comp_out->r1.c0[idx] =  matrix_comp_in->r1.c0[idx1];
    matrix_comp_out->r1.c1[idx] =  matrix_comp_in->r1.c1[idx1];
    matrix_comp_out->r1.c2[idx] =  matrix_comp_in->r1.c2[idx1];
    
    
    
    matrix_comp_out->r2.c0[idx] =  matrix_comp_in->r2.c0[idx1];
    matrix_comp_out->r2.c1[idx] =  matrix_comp_in->r2.c1[idx1];
    matrix_comp_out->r2.c2[idx] =  matrix_comp_in->r2.c2[idx1];
...
static inline void thmat1_plus_tamat2_times_factor_into_thmat1(
        __restrict thmat_soa * const thm1,
...
static inline void conf_left_exp_multiply(
        __restrict const su3_soa * const cnf, const int idx_cnf,
