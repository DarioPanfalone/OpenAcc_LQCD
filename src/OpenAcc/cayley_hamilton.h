																															...
																															__restrict const tamat_soa * QA,const int idx)
{
  ...
  double c0 = det_i_times_QA_soa(QA,idx); //(14) // det(Q) computation
  double c1  = 0.5 * Tr_i_times_QA_sq_soa(QA,idx); // (15)
  double c0max = 2*pow(c1/3,1.5); // (17) // could (c1/3)*sqrt(c1/3) be faster?!?!
																													...
																													__restrict single_tamat * const QA)
{
  ...
  double c0 = det_i_times_QA(QA); //(14) // det(Q) computation
