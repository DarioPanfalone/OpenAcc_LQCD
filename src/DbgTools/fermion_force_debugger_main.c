...
int main(){
  ...
  su3_soa  * conf_hasenbusch[0];
  int  allocation_check =  posix_memalign((void **)&conf_hasenbusch[0], ALIGN, 8*sizeof(su3_soa));
  if(allocation_check != 0)  printf("Errore nella allocazione di conf_hasenbusch[0] \n");
  SETREQUESTED(conf_hasenbusch[0]);
  ...
  generate_Conf_cold(conf_hasenbusch[0],0.0);
  //  generate_Conf_cold(conf_hasenbusch[0],0.1);
  ...
  conf_id_iter=0;
    ...
    stout_wrapper(conf_hasenbusch[0],tstout_conf_acc_arr,0);
    gconf_as_fermionmatrix = &tstout_conf_acc_arr[8*(STOUT_STEPS-1)];
#else
    gconf_as_fermionmatrix = conf_hasenbusch[0];
#endif
    ...
    DEOTT_fermion_force_soloopenacc( conf_hasenbusch[0],
#ifdef STOUT_FERMIONS
    ...
    // CAMBIARE UN LINK!!!!!!!!!!
    //    conf_hasenbusch[0][0].r0.c0[0] += 0.001 + 0.0*I;
    double eps=0.00001;
    ...
    single_su3 M;
    M.comp[0][0] =aux_conf_acc[i].r0.c0[s]*conf_hasenbusch[0][i].r0.c0[s]+aux_conf_acc[i].r0.c1[s]*conf_hasenbusch[0][i].r1.c0[s]+aux_conf_acc[i].r0.c2[s]*conf_hasenbusch[0][i].r2.c0[s];
    M.comp[0][1] =aux_conf_acc[i].r0.c0[s]*conf_hasenbusch[0][i].r0.c1[s]+aux_conf_acc[i].r0.c1[s]*conf_hasenbusch[0][i].r1.c1[s]+aux_conf_acc[i].r0.c2[s]*conf_hasenbusch[0][i].r2.c1[s];
    M.comp[0][2] =aux_conf_acc[i].r0.c0[s]*conf_hasenbusch[0][i].r0.c2[s]+aux_conf_acc[i].r0.c1[s]*conf_hasenbusch[0][i].r1.c2[s]+aux_conf_acc[i].r0.c2[s]*conf_hasenbusch[0][i].r2.c2[s];
    M.comp[1][0] =aux_conf_acc[i].r1.c0[s]*conf_hasenbusch[0][i].r0.c0[s]+aux_conf_acc[i].r1.c1[s]*conf_hasenbusch[0][i].r1.c0[s]+aux_conf_acc[i].r1.c2[s]*conf_hasenbusch[0][i].r2.c0[s];
    M.comp[1][1] =aux_conf_acc[i].r1.c0[s]*conf_hasenbusch[0][i].r0.c1[s]+aux_conf_acc[i].r1.c1[s]*conf_hasenbusch[0][i].r1.c1[s]+aux_conf_acc[i].r1.c2[s]*conf_hasenbusch[0][i].r2.c1[s];
    M.comp[1][2] =aux_conf_acc[i].r1.c0[s]*conf_hasenbusch[0][i].r0.c2[s]+aux_conf_acc[i].r1.c1[s]*conf_hasenbusch[0][i].r1.c2[s]+aux_conf_acc[i].r1.c2[s]*conf_hasenbusch[0][i].r2.c2[s];
    M.comp[2][0] =aux_conf_acc[i].r2.c0[s]*conf_hasenbusch[0][i].r0.c0[s]+aux_conf_acc[i].r2.c1[s]*conf_hasenbusch[0][i].r1.c0[s]+aux_conf_acc[i].r2.c2[s]*conf_hasenbusch[0][i].r2.c0[s];
    M.comp[2][1] =aux_conf_acc[i].r2.c0[s]*conf_hasenbusch[0][i].r0.c1[s]+aux_conf_acc[i].r2.c1[s]*conf_hasenbusch[0][i].r1.c1[s]+aux_conf_acc[i].r2.c2[s]*conf_hasenbusch[0][i].r2.c1[s];
    M.comp[2][2] =aux_conf_acc[i].r2.c0[s]*conf_hasenbusch[0][i].r0.c2[s]+aux_conf_acc[i].r2.c1[s]*conf_hasenbusch[0][i].r1.c2[s]+aux_conf_acc[i].r2.c2[s]*conf_hasenbusch[0][i].r2.c2[s];

    conf_hasenbusch[0][i].r0.c0[s] = M.comp[0][0];
    conf_hasenbusch[0][i].r0.c1[s] = M.comp[0][1];
    conf_hasenbusch[0][i].r0.c2[s] = M.comp[0][2];
    conf_hasenbusch[0][i].r1.c0[s] = M.comp[1][0];
    conf_hasenbusch[0][i].r1.c1[s] = M.comp[1][1];
    conf_hasenbusch[0][i].r1.c2[s] = M.comp[1][2];
    conf_hasenbusch[0][i].r2.c0[s] = M.comp[2][0];
    conf_hasenbusch[0][i].r2.c1[s] = M.comp[2][1];
    conf_hasenbusch[0][i].r2.c2[s] = M.comp[2][2];

    print_su3_soa(conf_hasenbusch[0],"conf_mod");
