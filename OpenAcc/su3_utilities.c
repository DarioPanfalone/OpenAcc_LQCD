...
void calc_loc_staples_removing_stag_phases_nnptrick_all_E_sites(  __restrict su3_soa * const u,
								  __restrict su3_soa * const loc_stap ){
  //       r+mu-nu  r+mu   r+mu+nu
  //          +<-----+----->+
  //          |  1L  ^  1R  |
...
void calc_loc_staples_removing_stag_phases_nnptrick_all_O_sites(  __restrict su3_soa * const u,
								  __restrict su3_soa * const loc_stap ){
  //       r+mu-nu  r+mu   r+mu+nu
  //          +<-----+----->+
  //          |  1L  ^  1R  |
