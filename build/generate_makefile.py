...
COMPILER_FLAGS=-O3 -acc -Minfo=all -v -ta=tesla:cc35,cuda7.0 -DUSE_MPI_CUDA_AWARE -I${MPIINC}\n\
LINKER_FLAGS=-acc -lmpi -Minfo=all -O3 -v -ta=tesla:cc35,cuda7.0 -L${MPILIB}\n' 
